...
def escalar(valor, max_valor=0.0003):
    """Escala el valor al rango [0, 255] saturado"""
...
class RawPC2Parser(Node):
    ...
    def pose_cb(self, msg: PoseStamped):
        ...
        backward_offset = 0.04  # por ejemplo, 4 cm hacia atrás
        back_vec = -R[:, 2]
        offset = 0.0425
    ...
    def octomap_cb(self, msg: PointCloud2):
        ...
        self.get_logger().info(
            f"overlap_right={overlap_right:.6f}, overlap_left={overlap_left:.6f} -> fuerzas: L={fuerza_L}, R={fuerza_R}"
        )
